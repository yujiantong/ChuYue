...
import com.chuyue.framework.shiro.service.SysPasswordService;
import com.chuyue.framework.util.ShiroUtils;
import com.chuyue.system.domain.SysUser;
import com.chuyue.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult addSave(@Validated SysUser user)
    {
        ...
        user.setPassword(passwordService.encryptAES(user.getPassword(), SysPasswordService.CHUYUE_KEY));
